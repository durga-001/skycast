...
import { GiPressureCooker, GiWaveCrest } from "react-icons/gi";
                  ...
                  <div className="forecast-scroll">
                    {(marine?.hourly || []).slice(0, 6).map((item, i) => (
                      <div className="forecast-card" key={item.time || i}>
                        ...
                        <div className="forecast-icon wave-emoji"><GiWaveCrest/></div>
                  ...
                  <div className="weekly-grid">
                    {(marine?.daily || []).map((day) => (
                      <div key={day.date} className="weekly-card">
                        ...
                        <div className="weekly-icon wave-emoji"><GiWaveCrest/></div>
                        <h4>
